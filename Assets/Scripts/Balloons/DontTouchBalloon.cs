...
public class DontTouchBalloon : Balloon
{
    ...
    */
    ...
    public void CalculateHealthColor()
    {
        ...
        if (health <= 0)
        {
            GetComponent<SpriteRenderer>().sprite = BalloonGraphicReferance.Instance.DonttouchBalloon0;
        }
        else if (health <= 25)
        {
            GetComponent<SpriteRenderer>().sprite = BalloonGraphicReferance.Instance.DonttouchBalloon25;
        }
        else if (health <= 50)
        {
            GetComponent<SpriteRenderer>().sprite = BalloonGraphicReferance.Instance.DonttouchBalloon50;
        }
        else if (health <= 75)
        {
            GetComponent<SpriteRenderer>().sprite = BalloonGraphicReferance.Instance.DonttouchBalloon75;
        }
